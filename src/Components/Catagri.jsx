...
const Catagri = () => {
  return (
    <>
      <div className='grid grid-cols-1 md:grid-cols-2 h-full container-md px-6 md:px-16 lg:px-24 mx-auto'>
        {/* Main Image */}
  ...
  <img src={nails} alt="nails" className="w-full h-full object-cover aspect-square" />
</div>
        ...
        <div className='h-auto md:h-[100vh] grid grid-cols-1 sm:grid-cols-2 w-full gap-5'>
          ...
          <div className='w-full relative overflow-hidden mt-0 md:mt-0 cursor-pointer'>
            <h3 className='absolute top-[50%] left-[50%] translate-x-[-50%] w-44 translate-y-[-50%] text-xl md:text-2xl font-bold text-[#Ac6236] z-10 text-center'>Hair Products</h3>
            ...
            <img src={hair} alt="hair" className='w-full h-auto transition-transform duration-500 ease-in-out hover:scale-110' />
          </div>

          {/* Second */}
          <div className='w-full flex justify-center items-center mt-5 md:mt-10 relative overflow-hidden cursor-pointer'>
            <h3 className='absolute top-[50%] left-[50%] w-44 translate-x-[-50%] translate-y-[-50%] text-xl md:text-2xl font-bold text-[#Ac6236] z-10 text-center'>Accessories</h3>
            ...
            <img src={jewearlry} alt="jewearlry" className='w-full h-auto transition-transform duration-500 ease-in-out hover:scale-110' />
          </div>

          {/* Third */}
          <div className='w-full relative mt-5 md:mt-10 overflow-hidden cursor-pointer'>
            <h3 className='absolute top-[50%] w-44 left-[50%] translate-x-[-50%] translate-y-[-50%] text-xl md:text-[25px] font-bold text-[#Ac6236] z-10 text-center'>Makeup</h3>
            ...
            <img src={makup} alt="makup" className='w-full h-auto transition-transform duration-500 ease-in-out hover:scale-110' />
          </div>

          {/* Fourth */}
          <div className='w-full relative mt-5 md:mt-10 overflow-hidden cursor-pointer'>
            <h3 className='absolute top-[50%] w-56 left-[50%] translate-x-[-50%] translate-y-[-50%] text-xl md:text-2xl font-bold text-[#Ac6236] z-10 text-center'>Multiple Products</h3>
            ...
            <img src={multi} alt="multi" className='w-full h-auto transition-transform duration-500 ease-in-out hover:scale-110' />
          </div>
        </div>
      </div>
    </>
